...
export const academicRules = [
  ...
  {
    id: "chinaxiv",
    matches: ["*://www.chinaxiv.org/*", "*://chinaxiv.org/*"],
    enableRichTranslate: false,
    sameLangCheck: false,
    selectors: [".paper"],
    excludeSelectors: [
      ...
      "#journalSelect",
      ".paper .side",
      ".paper .bd > ul > li:nth-child(1)",
      ".paper .bd > ul > li:nth-child(2)",
      ".paper .bd > ul > li:nth-child(4)",
      ".paper .bd > ul > li:nth-child(5)",
      ".paper .bd > ul > li:nth-child(6)",
      ".paper-tab-header",
      "button",
      "table",
      "time",
    ...
    atomicBlockSelectors: [".paper .bd > div", ".paper .title"],
    mutationExcludeSelectors: [
      ".MathJax",
      ".MathJax_Menu",
      ".MathJax_Message",
